...
apt-get install -y build-essential checkinstall libjansson-dev python-dev automake make gcc libimage-exiftool-perl libmagic-dev byacc python-pip pcregrep libpcre++-dev libtool  flex bison gcc unzip libssl-dev mongodb-org &>> $logfile
